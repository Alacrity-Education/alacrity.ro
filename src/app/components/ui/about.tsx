...
export default function About() {
  const maskStyle = {
    maskImage: `
      url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1200 120' preserveAspectRatio='none'%3e%3cpath d='M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3 V120 H0 V27.35A600.21,600.21,0,0,0,321.39,56.44Z' fill='white' /%3e%3c/svg%3e"),
      linear-gradient(white, white)
    `,
    maskSize: "100% 10rem, 100% calc(100% - 10rem)",
    maskPosition: "top center, 0 10rem",
    maskRepeat: "no-repeat, no-repeat",
    WebkitMaskImage: `
      url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1200 120' preserveAspectRatio='none'%3e%3cpath d='M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3 V120 H0 V27.35A600.21,600.21,0,0,0,321.39,56.44Z' fill='white' /%3e%3c/svg%3e"),
      linear-gradient(white, white)
    `,
    WebkitMaskSize: "100% 10rem, 100% calc(100% - 10rem)",
    WebkitMaskPosition: "top center, 0 10rem",
    WebkitMaskRepeat: "no-repeat, no-repeat",
  };

  return (
    <div
      className="text-primary-content z-10 min-h-screen relative bg-gradient-to-br from-primary to-secondary pb-4 flex flex-col items-center"
      style={maskStyle}
    >
...
const Cyclone = ({ className }: { className?: string }) => (
  <svg
    className={className}
    viewBox="0 0 72 72"
