export default function AirBox() {
  return (
    <div className=" relative h-max bg-base-200 flex flex-col items-center py-20 ">
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-l from-primary via-base-200 to-primary opacity-10 md:opacity-40 brightness-150 hidden md:block dark:opacity-10"></div>
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-primary via-base-200 to-primary opacity-10 md:opacity-40 brightness-150 dark:opacity-10"></div>
      <div className="text-2xl sm:text-5xl z-10 font-bold">
        Meet Alacrity/
        <span className="z-10 text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary via-primary font-bold py-5">
          Airbox
        </span>
      </div>
      ...
      <p className=" z-10  md:text-xl max-w-4xl py-10 pt-2 px-4 sm:px-0">
        ...
        <br />
        <br />
        An <span className="text-primary">educational kit </span>
        ...
        autonomous after install and powered by{" "}
        <span className="text-primary ">high-precision sensors</span>
        <br />
